...
const ContentCreationProcess = () => {
  ...
  const currentPortfolioItem = portfolioItems[currentPortfolioIndex];
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={activeStepData?.image || processSteps[0].image}
          alt="Background"
          fill
      ...
      >
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            در کارخانه محتوا، ما با یک فرآیند منظم و خلاقانه، محتوای با کیفیت و
            ...
            <div className="grid grid-cols-6 gap-4 relative z-10">
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  >
                    <span className="text-white text-3xl">{step.icon && <step.icon />}</span>
              ...
              >
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <div className="flex items-center mb-3">
                    ...
                    >
                      <span className="text-white text-3xl">{type.icon && <type.icon />}</span>
                    </div>
        ...
        {/* Portfolio Showcase */}
        <div ref={portfolioRef} className="mb-32">
          <motion.h3
            className="text-2xl md:text-3xl font-bold text-white mb-12 text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={
          ...
          <div className="relative max-w-4xl mx-auto">
            <motion.div
              ...
              style={{
                boxShadow: `0 20px 50px -10px ${currentPortfolioItem.color}40`,
              }}
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div
                    className="absolute inset-0"
                    style={{
                      background: `linear-gradient(to top, ${currentPortfolioItem.color}CC, transparent)`,
                    }}
                  />
                </motion.div>
              </AnimatePresence>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                <motion.div
                  key={`title-${currentPortfolioItem.id}`}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 20 }}
                  transition={{ duration: 0.5 }}
                >
                  <span
                    ...
                    style={{
                      backgroundColor: `${currentPortfolioItem.color}66`,
                      color: "white",
                      border: `1px solid ${currentPortfolioItem.color}`,
                    }}
                  >
                    {currentPortfolioItem.type}
                  </span>
              ...
              <div className="absolute top-1/2 left-0 right-0 flex justify-between px-4 -translate-y-1/2 pointer-events-none">
                <motion.button
                  className="w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center pointer-events-auto"
                  style={{
                    border: `1px solid ${currentPortfolioItem.color}`,
                  }}
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <HiOutlineArrowRight className="text-white text-xl" />
                </motion.button>
                <motion.button
                  className="w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center pointer-events-auto"
                  style={{
            ...
            <div className="flex justify-center mt-6 gap-2">
              {portfolioItems.map((item, index) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  animate={{
                    scale: index === currentPortfolioIndex ? 1.2 : 1,
                  }}
                  transition={{ duration: 0.3 }}
                />
              ))}
