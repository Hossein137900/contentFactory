...
const ContentCreationLab = () => {
  ...
  const isExperimentsInView = useInView(experimentsRef, {
    once: false,
    margin: "-100px 0px",
  });
  ...
  const handleExperimentClick = (experimentId: string) => {
    setActiveExperiment(
      activeExperiment === experimentId ? null : experimentId
    );
  };
  ...
  // Get active formula data
  const activeFormulaData = contentFormulas.find(
    (formula) => formula.id === activeFormula
  );
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={activeFormulaData?.image || "/assets/images/cam1.jpg"}
          alt="Background"
          fill
      ...
      >
              ...
              >
                ...
                <div className="relative aspect-video">
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(to top, ${formula.color}CC, ${formula.color}33, transparent)`,
                    }}
                  />
                </div>
        ...
        {/* Content Experiments Section */}
        <div ref={experimentsRef} className="mb-32">
          <motion.h3
            className="text-2xl md:text-3xl font-bold text-white mb-12 text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={
              isExperimentsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
            transition={{ duration: 0.5 }}
          >
            آزمایش‌های محتوایی
          ...
          <div className="space-y-12">
            {contentExperiments.map((experiment, index) => (
              <motion.div
                key={experiment.id}
                ...
                style={{
                  ...
                  boxShadow: `0 10px 30px -5px ${experiment.color}40`,
                }}
                initial={{ opacity: 0, y: 20 }}
                animate={
                  isExperimentsInView
                  ...
                  <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                    ...
                    <div className="flex-1">
                      <div
                        ...
                        style={{
                          backgroundColor: `${experiment.color}33`,
                          color: experiment.color,
                          border: `1px solid ${experiment.color}66`,
                        }}
                      >
                        آزمایش #{index + 1}
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                        {experiment.stats.map((stat, statIndex) => (
                          <div
                            key={statIndex}
                      ...
                      <motion.button
                        ...
                        style={{
                          background: `linear-gradient(90deg, ${experiment.color}, ${experiment.color}CC)`,
                          boxShadow: `0 8px 20px -5px ${experiment.color}80`,
                        }}
                        onClick={() => handleExperimentClick(experiment.id)}
                        whileHover={{
                          scale: 1.05,
                          boxShadow: `0 12px 25px -5px ${experiment.color}80`,
                        }}
                        whileTap={{ scale: 0.98 }}
                      >
                        {activeExperiment === experiment.id ? (
                          <>
                            <span>مشاهده نتیجه اولیه</span>
                            <HiOutlineArrowLeft />
                          </>
                        ) : (
                          <>
                    ...
                    <div className="w-full md:w-2/5 relative aspect-video md:aspect-auto">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          ...
                          <div
                            className="absolute bottom-0 left-0 right-0 p-2 text-center text-sm"
                            style={{
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {contentTools.map((tool, index) => (
              <motion.div
                key={tool.id}
                className="relative cursor-pointer rounded-xl overflow-hidden backdrop-blur-lg"
                style={{
                  boxShadow: `0 10px 30px -5px ${tool.color}40`,
        ...
        >
          {[
            ...
            { value: "+۵۰۰", label: "پروژه موفق", icon: <HiOutlineSparkles /> },
            { value: "+۹۵٪", label: "رضایت مشتری", icon: <HiOutlineCheck /> },
            {
              value: "+۲۰۰٪",
              label: "میانگین رشد",
            ...
            <motion.div
              ...
              whileHover={{
                ...
                boxShadow: `0 10px 30px -5px ${
                  contentElements[index % contentElements.length].color
                }40`,
              }}
            >
              <div className="flex justify-center mb-3">
                <motion.div
                  className="w-12 h-12 text-xl rounded-full flex items-center justify-center"
                  style={{
                    backgroundColor: `${
                      contentElements[index % contentElements.length].color
                    }20`,
              ...
              <motion.h3
                ...
                style={{
                  color: contentElements[index % contentElements.length].color,
                }}
                animate={{
                  scale: [1, 1.05, 1],
                  opacity: [0.9, 1, 0.9],
