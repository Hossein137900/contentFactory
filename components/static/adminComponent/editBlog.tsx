  ...
  if (!blogs || blogs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh]">
        <svg
          className="w-48 h-48 mb-8 text-gray-300"
        ...
        <h2 className="text-2xl font-bold text-gray-200 mb-2">بلاگی یافت نشد</h2>
        <p className="text-gray-400 text-center">
          در حال حاضر هیچ بلاگی وجود ندارد. لطفاً بعداً دوباره بررسی کنید.
        </p>
      </div>
    );
  }
