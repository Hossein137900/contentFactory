                      ...
                      >
                        ...
                        <div 
                          className={`relative z-10 flex items-center justify-center w-8 h-8 rounded-md ${
                            activeItem === index ? "bg-gray-700" : "bg-gray-800/50"
                          }`}
    ...
    return (
      <div className="fixed bottom-6 left-0 right-0 z-50 px-4">
        ...
        >
          {/* Mobile menu bar */}
          <motion.div
            className="flex items-center justify-center p-3 bg-gray-900/90 backdrop-blur-lg rounded-full border border-gray-700/30 mx-auto"
            style={{
              boxShadow: "0 10px 25px rgba(0, 0, 0, 0.2)",
            }}
          >
            {/* Main navigation items */}
            <div className="flex items-center justify-between gap-4 md:gap-8 w-full px-2">
              {menuItems.map((item, index) => (
                <motion.a
                  key={index}
                  href={item.href}
                ...
                >
                  <motion.div
                    className={`flex items-center justify-center w-10 h-10 rounded-full ${
                      activeItem === index ? "bg-gray-800" : "bg-transparent"
                    }`}
                    animate={{
                      backgroundColor: activeItem === index ? "rgba(31, 41, 55, 0.8)" : "transparent",
                    }}
                    transition={{ duration: 0.2 }}
                    ref={item.hasSocials ? shareButtonRef : null}
                  >
