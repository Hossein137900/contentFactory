...
export const contentFormulas: ContentFormula[] = [
  ...
  {
    id: "formula2",
    title: "فرمول افزایش فروش",
    description: "ترکیبی مؤثر برای تبدیل بازدیدکنندگان به مشتریان وفادار",
    elements: ["St", "Da", "Au"],
    result: "افزایش ۸۰٪ در نرخ تبدیل",
    image: "/assets/images/cam2.jpg",
    color: "#3B82F6", // Blue
  },
  {
    id: "formula3",
    title: "فرمول رشد ارگانیک",
    description: "ترکیبی هوشمندانه برای افزایش ترافیک ارگانیک و بهبود سئو",
    elements: ["Op", "Au", "Cr"],
    result: "افزایش ۲۰۰٪ در ترافیک ارگانیک",
...
export const contentExperiments: ContentExperiment[] = [
  ...
  {
    id: "experiment3",
    title: "آزمایش بهینه‌سازی سئو",
    description:
      "بهینه‌سازی ساختار و محتوای سایت برای بهبود رتبه در موتورهای جستجو",
    before: "/assets/images/cam3.jpg",
    after: "/assets/images/cam1.jpg",
    stats: [
      {
        label: "افزایش رتبه",
        value: "۱۵ پله",
      ...
      { label: "افزایش ترافیک", value: "۲۸۰٪", icon: HiOutlineGlobe },
      { label: "افزایش کلیک", value: "۱۹۰٪", icon: HiOutlineEye },
    ],
    color: "#10B981", // Emerald
  },
];
